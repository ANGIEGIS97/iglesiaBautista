<template>
  <footer class="w-full py-5 sm:py-10 px-4 bg-gray-800">
    ...
    >
      ...
      >
        ...
        <blockquote class="text-center">
          ...
          no por obras, para que nadie se gloríe.<br />
          Efesios 2:8-9
        </blockquote>
        <div class="mt-auto flex flex-col items-center">
          ...
          >
            <a
              ...
              class="text-gray-200 hover:text-teal-400"
            >
            ...
            <a
              ...
              class="ml-3 text-gray-200 hover:text-teal-400"
            >
              ...
              >
                <path
                  d="M21.2,7.7c-0.3-1.1-0.9-2-1.7-2.8C18.7,4.6,16.7,4,12,4S5.3,4.6,3.5,4.9C2.7,5.7,2.1,6.6,1.8,7.7C1.5,8.9,1.5,10.4,1.5,12s0,3.1,0.3,4.3c0.3,1.1,0.9,2,1.7,2.8C5.3,19.4,7.3,20,12,20s6.7-0.6,8.5-0.9c0.8-0.7,1.4-1.7,1.7-2.8c0.3-1.1,0.3-2.6,0.3-4.3s0-3.1-0.3-4.3zM9.8,15.3V8.7l5.6,3.3L9.8,15.3z"
                ></path>
              </svg>
            </a>
          </span>
      ...
      <div class="grid grid-cols-2 gap-5 text-gray-400">
        ...
        >
          <h3 class="py-1.5 md:py-4 text-xl text-white font-bold tracking-wide">
            Navegación
          </h3>
          <nav
          ...
          >
            ...
            <li>
              <a href="#ministerios" class="hover:text-gray-200">Ministerios</a>
            </li>
            <li>
              <a
                href="confesion.html"
